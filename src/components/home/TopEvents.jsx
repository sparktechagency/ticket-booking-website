    ...
    <div className="bg-[#04092C] py-6 sm:py-8 md:py-10  xl:py-20  px-4 sm:px-6 md:px-12 lg:px-24 xl:px-56">
      ...
      <Slider {...settings}>
        {eventsData.map((event) => (
          <div key={event.id} className="px-2 sm:px-3">
            <motion.div
            ...
            >
              ...
              <div className="relative">
                <Image
                  src={event.image.src}
                  alt={event.title}
                  className="w-full h-40 sm:h-48 md:h-56 lg:h-64 object-fit"
                />
                <span
              ...
              <div className="flex flex-col p-3 sm:p-4 md:p-5 flex-1">
                ...
                >
                  {event.matchup || event.artist || "N/A"}
                </p>
                ...
                <div className="space-y-1 sm:space-y-1.5 mb-3 sm:mb-4">
                  ...
                  <div className="flex items-start gap-1.5 sm:gap-2">
                    ...
                    >
                      ...
                      <p>{event.venue.city || "N/A"},</p>
                      <p>{event.venue.country || "N/A"}</p>
                    </div>
                  </div>
                </div>
