          ...
          <div key={sport.id} className="px-2 sm:px-3">
            ...
            >
              ...
              <div className="flex flex-col p-3 sm:p-4 md:p-5 flex-1">
                ...
                >
                  {sport.teams[0] || "N/A"} vs {sport.teams[1] || "N/A"}
                </p>
                ...
                <div className="space-y-1 sm:space-y-1.5 mb-3 sm:mb-4">
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    ...
                    >
                      <span>{sport.date || "N/A"}</span>
                      <GoDotFill className="text-[8px] sm:text-[10px]" />
                      <span>{sport.time || "N/A"}</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-1.5 sm:gap-2">
                    ...
                    >
                      <p>{sport.venue.name || "N/A"},</p>
                      <p>{sport.venue.city || "N/A"},</p>
                      <p>{sport.venue.country || "N/A"}</p>
                    </div>
                  </div>
                </div>
